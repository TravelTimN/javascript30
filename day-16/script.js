document.addEventListener("DOMContentLoaded", function () {
    ...
    function shadow(e) {
        ...
        text.style.textShadow = `
            ${xWalk}px ${yWalk}px 15px rgba(112, 187, 31, 0.5),
            ${xWalk * -1}px ${yWalk}px 15px rgba(187, 31, 34, 0.5),
            ${yWalk}px ${xWalk * -1}px 15px rgba(31, 112, 187, 0.5),
            ${yWalk * -1}px ${xWalk}px 15px rgba(187, 184, 31, 0.5)
        `;
